    ...
    for ci, ciphertext in enumerate(ciphertexts):
        ...
        for iter, cipher_letter in enumerate(ciphertext):
            ...
            if cipher_letter in string.ascii_letters:
                ...
                cipher_letter = string.ascii_lowercase[(26 + string.ascii_lowercase.index(
                    cipher_letter) - string.ascii_lowercase.index(current[iter])) % (len(string.ascii_lowercase))]
                if upper:
